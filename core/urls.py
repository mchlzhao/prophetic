...
urlpatterns = [
    ...
    path('group/<int:group_id>/add_member_ajax/', views.add_member_ajax, name='add_member_ajax'),
    ...
    path('event/<int:event_id>/market/orders/', views.get_market_orders_and_position, name='market_orders'),
